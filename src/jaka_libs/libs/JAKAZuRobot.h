...
public:
	...
	*/
	...
	/**
	* @brief SERVO模式下不使用滤波器,该指令在SERVOJ模式下不可设置，退出SERVOJ后可设置
	* @return ERR_SUCC 成功 其他失败
	*/
	errno_t  servo_move_use_none_filter();

	/**
	* @brief SERVO模式下关节空间一阶低通滤波,该指令在SERVOJ模式下不可设置，退出SERVOJ后可设置
	...
	*/
	...
	/**
	* @brief SERVO模式下关节空间非线性滤波,该指令在SERVOJ模式下不可设置，退出SERVOJ后可设置
	...
	*/
	...
	/**
	* @brief SERVO模式下笛卡尔空间非线性滤波,该指令在SERVOJ模式下不可设置，退出SERVOJ后可设置
	...
	*/
	...
	/**
	* @brief SERVO模式下关节空间多阶均值滤波器,该指令在SERVOJ模式下不可设置，退出SERVOJ后可设置
	...
	* @param compliance_type 0 代表恒力柔顺控制,1 代表速度柔顺控制
	* @return ERR_SUCC 成功 其他失败
	*/
